...
export default function Sidebar({ currentView, setCurrentView }) {
  ...
  const profileClass = classNames("app-sidebar__profile", {
    "app-sidebar__profile--active": currentView === VIEWS.PROFILE,
  });
  const homeClass = classNames("app-sidebar__menu-item", {
    "app-sidebar__menu-item--active": currentView === VIEWS.HOME,
  });
  const statsClass = classNames("app-sidebar__menu-item", {
    "app-sidebar__menu-item--active": currentView === VIEWS.STATS,
  });
